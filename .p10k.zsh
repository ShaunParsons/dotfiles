# Generated by Powerlevel10k configuration wizard on 2026-05-12 at 22:21 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#2aa198'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#586e75}'  # solarized base01
      local      clean='%F{#839496}'  # solarized base0
      local   modified='%F{#b58900}'  # solarized yellow
      local  untracked='%F{#2aa198}'  # solarized cyan
      local conflicted='%F{#dc322f}'  # solarized red
    else
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#859900'
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#859900'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#657b83'
